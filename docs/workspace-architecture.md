...
| [`containers/compose/base.yaml`](../containers/compose/base.yaml) | Mounts the parent directory (so all sibling repos appear at `/workspaces`) and runs the Redis sidecar. |
